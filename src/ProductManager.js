...
class ProductManager {
    ...
    async updateProduct(id, fields) {
        ...
        const productsUpdated = JSON.parse(products).map(prod => prod.id === Number(id) ? product : prod)
    ...
    async deleteProduct(id) {
        ...
        const productRemoved = JSON.parse(products).filter(prod => prod.id !== Number(id))
